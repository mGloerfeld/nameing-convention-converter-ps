...
.DESCRIPTION
   PascalCase: Ähnlich wie CamelCase, aber der erste Buchstabe ist ebenfalls großgeschrieben. Beispiel: PascalCaseBeispiel.
.EXAMPLE
   ConvertTo-Upper-PascalCase("Unified Canadian Aboriginal Syllabics")
.EXAMPLE
